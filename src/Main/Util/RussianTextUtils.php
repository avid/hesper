...
final class RussianTextUtils extends StaticFactory {
	 ...
	 * @param $cases array of words to select from array('результат', 'результата', 'результатов')
	 **/
	...
	public static function getDayOfWeek($day, $full = false) {
		static $weekDays = ['вс', 'пн', 'вт', 'ср', 'чт', 'пт', 'сб', 'вс'];

		static $weekDaysFull = ['Воскресенье', 'Понедельник', 'Вторник', 'Среда', 'Четверг', 'Пятница', 'Суббота', 'Воскресенье'];
	...
	public static function detectEncoding($data) {
		static $tables = ['KOI8-R' => [], 'WINDOWS-1251' => []];
