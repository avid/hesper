...
use Hesper\Main\Util\AMQP\AMQPBaseChannel;
use Hesper\Main\Util\AMQP\AMQPChannelInterface;
use Hesper\Main\Util\AMQP\AMQPConsumer;
use Hesper\Main\Util\AMQP\AMQPExchangeConfig;
use Hesper\Main\Util\AMQP\AMQPExchangeType;
...
use Hesper\Main\Util\AMQP\Exception\AMQPServerException;

/**
 * Class AMQPPeclChannel
...
final class AMQPPeclChannel extends AMQPBaseChannel
{
	...
	**/
	 ...
	 * @throws AMQPServerException|AMQPServerConnectionException|WrongStateException
