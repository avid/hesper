...
final class TidyValidator {
	...
	private $config = ['output-xhtml' => true, 'doctype' => 'strict', 'wrap' => 0, 'quote-marks' => true, 'drop-empty-paras' => true];
	 ...
	 * @param $content string content itself
	 * @return TidyValidator
	 **/
	 ...
	 * @param $header string header string
	 * @return TidyValidator
	 **/
	...
	public function validateContent($content = null) {
		static $symbols = ['…' => '&hellip;', '™' => '&trade;', '©' => '&copy;', '№' => '&#8470;', '—' => '&mdash;', '–' => '&mdash;', '«' => '&laquo;', '»' => '&raquo;', '„' => '&bdquo;', '“' => '&ldquo;', '•' => '&bull;', '®' => '&reg;', '¼' => '&frac14;', '½' => '&frac12;', '¾' => '&frac34;', '±' => '&plusmn;'];
