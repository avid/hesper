...
use Hesper\Core\DB\Transaction\AccessMode;
use Hesper\Core\DB\Transaction\IsolationLevel;
...
abstract class DB {
	...
	public function getDialect() {
		return $this->dialect = $this->dialect ?: ($this->spawnDialect()
		                                                ->setDB($this));
	}
